...
contract TrusterChallenge is Test {
    ...
    function test_truster() public checkSolvedByPlayer {
        // Aegis sweep -> approval-drain-arbitrary-call: flashLoan does target.functionCall(data)
        // while holding funds. Point it at the token with approve(attacker, all), then transferFrom.
        // One tx (player nonce must be 1): the attacker's constructor does it all.
