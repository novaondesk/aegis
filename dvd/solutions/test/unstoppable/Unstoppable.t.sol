...
contract UnstoppableChallenge is Test {
    ...
    function test_unstoppable() public checkSolvedByPlayer {
        // Aegis sweep -> erc4626-inflation family: totalAssets reads balanceOf(this), and flashLoan
        // enforces convertToShares(totalSupply) == balanceOf. A direct donation breaks that strict
        // invariant, permanently reverting flashLoan (DoS); the monitor then pauses + hands ownership.
